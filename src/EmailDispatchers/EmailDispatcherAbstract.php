...
abstract class EmailDispatcherAbstract
{
     ...
     * @param EmailCreatorInterface $email
     * @return EmailSent
     */
   protected function recordEmailInDatabase(EmailRecipientData $emailRecipientData, EmailCreatorInterface $email):EmailSent
   {
       return EmailSent::create([
            'email_address' => $emailRecipientData->getEmailAddress(),
